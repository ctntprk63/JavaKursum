...
public class task2 {
    // 1. Adim : ayri dosyada olmak üzere customer isimli  (fields: name) isimli bir class olusturun
    // 2.Adim ayri bir dosyada ElektricityAcount isimli (fields. totalKw,rate(double), bill)
